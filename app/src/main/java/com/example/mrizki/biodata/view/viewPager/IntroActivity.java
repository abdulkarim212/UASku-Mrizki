package com.example.mrizki.biodata.view.viewPager;
...
public class IntroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* if (restorePrefData()) {
        ...
        mList.add(new ScreenItem("WELCOME","Selamat Datang Di Aplikasi Profil saya",R.drawable.info));
        mList.add(new ScreenItem("FITUR ","Aplikasi ini mempunyai 3 fitur yaitu menu profil, menu Contact dan menu Friend",R.drawable.img2));
        mList.add(new ScreenItem("GO","",R.drawable.gambar3));
